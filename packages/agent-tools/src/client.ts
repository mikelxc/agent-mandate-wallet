import { createMerchantClient } from 'wayleave-merchant';
import { parseCctpIntent } from "@mandate/sdk";
...
export type GatewayClient = ReturnType<typeof createMerchantClient> & {
...
export function createGatewayClient(
  ...
  if (!configuredToken) throw new Error("WAYLEAVE_AGENT_TOKEN is required. Create a bearer token in Wayleave with your wallet.");
